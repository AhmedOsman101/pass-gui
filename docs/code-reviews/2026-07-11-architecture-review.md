...
| 2   | **Collapse Move+Duplicate dialogs** into one parameterized module        | Strong          | ✅ Done | DuplicateEntryDialog.vue (211L), MoveEntryDialog.vue (215L)                                                                         | ~190 duplicate lines between two dialogs. Bug fixes don't propagate.                                                                      |
| 3   | **Consolidate password generator** -- triplicated UI into one composable | Worth exploring | ✅ Done | PasswordGenerator.vue (194L), EntryForm.vue generator panel (~70L), GenerateDialog.vue (234L)                                       | 3 components duplicating the same memorable/length/symbols/regenerate pattern. ~200 duplicate lines.                                      |
...
- ~~Explore candidate 2 (collapse Move+Duplicate dialogs) -- implemented~~ ✅ Done
- ~~Explore candidate 3 (password generator consolidation) -- implemented~~ ✅ Done
